...
/**
 * URL base del storage de Laravel (imágenes de productos, avatares, etc.)
 * Por defecto se deduce de LARAVEL_API_URL (mismo origen, ruta /storage/)
 */
define('LARAVEL_STORAGE_URL', preg_replace('#/api/?$#', '/', LARAVEL_API_URL) . 'storage/');
