...
1️⃣ Poner en los headers lo siguiente:  **Accept: application/json**

2️⃣ Hacer las migraciones de las tablas usando este comando en la terminal: **php artisan migrate:fresh** teniendo el servidor ya creado
