...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        } elseif (!(str_ends_with(strtolower($email), "@soy.sena.edu.co") || str_ends_with(strtolower($email), "@gmail.com"))) {
...
<?php if (isUsingLaravelApi()): ?>
    <script>
        ...
        var apiBase = typeof API_CONFIG !== 'undefined' ? API_CONFIG.LARAVEL_URL : <?= json_encode(defined('LARAVEL_API_URL') ? LARAVEL_API_URL : 'https://omwekiatl.xyz/api/') ?>;
